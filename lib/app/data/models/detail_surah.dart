...
// jika data (null di API) maka kita harus buat perkondisian dengan cara ( json["preBismillah"] == null ? null : ) NOTIF: (Exception has occurred. _TypeError (type 'List<dynamic>' is not a subtype of type 'Map<String, dynamic>'))
